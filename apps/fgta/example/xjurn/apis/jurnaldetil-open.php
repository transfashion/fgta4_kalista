...
class DataOpen extends WebAPI {
	...
	public function execute($options) {
		...
		try {
			...
			$sql = \FGTA4\utils\SqlUtility::Select('trn_jurnaldetil', [
				'jurnaldetil_id', 'jurnaldetil_descr', 'jurnaldetil_value', 'acc_id', 'jurnal_id', '_createby', '_createdate', '_modifyby', '_modifydate' 
			], $where->sql);
