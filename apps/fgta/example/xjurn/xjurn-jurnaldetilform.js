...
const obj = {
	...
	txt_jurnaldetil_descr: $('#pnl_editjurnaldetilform-txt_jurnaldetil_descr'),
	txt_jurnaldetil_value: $('#pnl_editjurnaldetilform-txt_jurnaldetil_value'),
	cbo_acc_id: $('#pnl_editjurnaldetilform-cbo_acc_id'),
...
export async function init(opt) {
	...
	obj.cbo_acc_id.name = 'pnl_editjurnaldetilform-cbo_acc_id'		
...
async function form_datasaved(result, options) {
	...
	form.rowid = $ui.getPages().ITEMS['pnl_editjurnaldetilgrid'].handler.updategrid(data, form.rowid)
