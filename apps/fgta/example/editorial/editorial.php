...
if (is_file(__DIR__ .'/editorial.php-handler.php')) {
	require_once __DIR__ .'/editorial.php-handler.php';
}

/**
 * fgta/example/editorial/editorial.php
 *
 * ===================================================================
 * Entry point Program Module editorial
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\editorial_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new editorial_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
