...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		...
		try {
			...
			$obj->acc_id = strtoupper($obj->acc_id);
			$obj->acc_name = strtoupper($obj->acc_name);
			$obj->accgroup_id = strtoupper($obj->accgroup_id);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'acc_id', 'acc_name', 'accgroup_id', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
			...
			$result->dataresponse = (object) array_merge($dataresponse, [
				...
				'accgroup_name' => \FGTA4\utils\SqlUtility::Lookup($data->accgroup_id, $this->db, 'mst_accgroup', 'accgroup_id', 'accgroup_name'),
