...
const obj = {
	txt_accgroup_id: $('#pnl_edit-txt_accgroup_id'),
	txt_accgroup_name: $('#pnl_edit-txt_accgroup_name'),
	txt_accgroup_descr: $('#pnl_edit-txt_accgroup_descr'),
	chk_accgroup_isdisabled: $('#pnl_edit-chk_accgroup_isdisabled')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_accgroup_id,
		autoid: false,
		logview: 'mst_accgroup',
		btn_edit: btn_edit,
		btn_save: btn_save,
