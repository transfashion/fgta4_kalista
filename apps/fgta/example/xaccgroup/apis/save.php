...
class DataSave extends WebAPI {
	...
	public function execute($data, $options) {
		$tablename = 'mst_accgroup';
		$primarykey = 'accgroup_id';
		...
		try {
			...
			$obj->accgroup_name = strtoupper($obj->accgroup_name);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey, 'accgroup_id', 'accgroup_name', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
