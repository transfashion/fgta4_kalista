...
/**
 * fgta/riset/upfile/apis/detil-save.php
 *
 * ==========
 * Detil-Save
 * ==========
	...
	public function execute($data, $options, $files) {
		...
		try {
			...
			try {
				...
				$header_table = 'mst_upfile';
				$header_primarykey = 'upfile_id';
				...
				$fieldname = 'upfiledetil_data02';	
				if (property_exists($files, $fieldname)) {

					$file_id = $obj->{$primarykey} . "|file2";
					$doc = $files->{$fieldname};
					$file_base64data = $doc->data;
					unset($doc->data);
			...
			$sql = \FGTA4\utils\SqlUtility::Select($tablename , [
				$primarykey
				, 'upfiledetil_id', 'upfiledetil_name', 'upfiledetil_data01', 'upfiledetil_data02', 'upfile_id', '_createby', '_createdate', '_modifyby', '_modifydate', '_createby', '_createdate', '_modifyby', '_modifydate'
			], $where->sql);
