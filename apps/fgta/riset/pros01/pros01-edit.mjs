...
const obj = {
	txt_pros01_id: $('#pnl_edit-txt_pros01_id'),
	txt_pros01_name: $('#pnl_edit-txt_pros01_name'),
	chk_pros01_iscommit: $('#pnl_edit-chk_pros01_iscommit'),
	txt_pros01_commitby: $('#pnl_edit-txt_pros01_commitby'),
	txt_pros01_commitdate: $('#pnl_edit-txt_pros01_commitdate'),
	txt_pros01_version: $('#pnl_edit-txt_pros01_version')
}
...
function updaterecordstatus(record) {
	// apabila ada keperluan untuk update status record di sini
		...
		rec_commitby.html(record.pros01_commitby);
		rec_commitdate.html(record.pros01_commitdate);
...
function updategridstate(record) {
	...
	var col_commit = 'pros01_iscommit';
	updategriddata[col_commit] = record.pros01_iscommit;	
...
function btn_print_click() {
	...
	var id = obj.txt_pros01_id.textbox('getValue');
	var printurl = 'index.php/printout/' + window.global.modulefullname + '/pros01.xprint?id=' + id;
...
async function btn_action_click(args) {
	...
	var docname = 'Proses 01'
	var txt_version = obj.txt_pros01_version;
	var chk_iscommit = obj.chk_pros01_iscommit;
