...
import * as hnd from  './dash-edit-hnd.mjs'
...
const obj = {
	txt_dash_id: $('#pnl_edit-txt_dash_id'),
	txt_dash_name: $('#pnl_edit-txt_dash_name'),
	txt_dash_descr: $('#pnl_edit-txt_dash_descr'),
	txt_dash_module: $('#pnl_edit-txt_dash_module')
}
