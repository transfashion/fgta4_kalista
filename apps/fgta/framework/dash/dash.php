...
if (is_file(__DIR__ .'/dash.php-handler.php')) {
	require_once __DIR__ .'/dash.php-handler.php';
}

/**
 * fgta/framework/dash/dash.php
 *
 * ===================================================================
 * Entry point Program Module dash
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\dash_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new dash_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
