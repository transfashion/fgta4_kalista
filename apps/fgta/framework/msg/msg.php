...
if (is_file(__DIR__ .'/msg.php-handler.php')) {
	require_once __DIR__ .'/msg.php-handler.php';
}

/**
 * fgta/framework/msg/msg.php
 *
 * ===================================================================
 * Entry point Program Module msg
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\msg_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new msg_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
