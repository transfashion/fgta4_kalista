...
/**
 * fgta/framework/msg/apis/save.php
 *
 * ====
 * Save
 * ====
...
$API = new class extends msgBase {
	...
	public function execute($data, $options) {
		...
		try {
			...
			unset($obj->msg_isactive);
			unset($obj->msg_activedate);
			unset($obj->msg_isprocess);
			unset($obj->msg_processdate);
			unset($obj->msg_issend);
			unset($obj->msg_isfail);
			unset($obj->msg_senddate);
			unset($obj->msg_ismarktodel);
