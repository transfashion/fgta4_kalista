...
/**
 * fgta/framework/msgcopy/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header msgcopy (mst_msgcopy)
...
$API = new class extends msgcopyBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.msgcopy_id LIKE CONCAT('%', :search, '%') OR A.msgcopy_name LIKE CONCAT('%', :search, '%') "
			];
			if (is_object($hnd)) {
