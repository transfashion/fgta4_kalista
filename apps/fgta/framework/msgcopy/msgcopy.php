...
if (is_file(__DIR__ .'/msgcopy.php-handler.php')) {
	require_once __DIR__ .'/msgcopy.php-handler.php';
}

/**
 * fgta/framework/msgcopy/msgcopy.php
 *
 * ===================================================================
 * Entry point Program Module msgcopy
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\msgcopy_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new msgcopy_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
