...
import * as hnd from  './msgcopy-edit-hnd.mjs'
...
const obj = {
	txt_msgcopy_id: $('#pnl_edit-txt_msgcopy_id'),
	txt_msgcopy_name: $('#pnl_edit-txt_msgcopy_name')
}
