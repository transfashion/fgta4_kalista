...
const obj = {
	...
	txt_jurnal_note: $('#pnl_edit-txt_jurnal_note')
}
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editjurnaldetilgrid'].handler.createnew(data, options)
		$ui.getPages().ITEMS['pnl_editjurnalpaymngrid'].handler.createnew(data, options)
