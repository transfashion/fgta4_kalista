...
if (is_file(__DIR__ .'/fgrole.php-handler.php')) {
	require_once __DIR__ .'/fgrole.php-handler.php';
}

/**
 * fgta/framework/fgrole/fgrole.php
 *
 * ===================================================================
 * Entry point Program Module fgrole
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\fgrole_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new fgrole_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
