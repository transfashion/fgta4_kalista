...
import * as hnd from  './fgrole-edit-hnd.mjs'
...
const obj = {
	txt_role_id: $('#pnl_edit-txt_role_id'),
	txt_role_name: $('#pnl_edit-txt_role_name'),
	txt_role_descr: $('#pnl_edit-txt_role_descr')
}
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editpermissiongrid'].handler.createnew(data, options)
