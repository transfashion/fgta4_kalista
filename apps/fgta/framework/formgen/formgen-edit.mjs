...
const obj = {
	...
	txt_nama: $('#pnl_edit-txt_nama'),
	txt_alamat: $('#pnl_edit-txt_alamat'),
	chk_disabled: $('#pnl_edit-chk_disabled'),
	txt_city: $('#pnl_edit-txt_city'),
	dt_tanggal: $('#pnl_edit-dt_tanggal'),
	cbo_gender: $('#pnl_edit-cbo_gender'),
	txt_nilai: $('#pnl_edit-txt_nilai')
}
...
async function PreLoadGender() {
	...
	try {
		...
		obj.cbo_gender.combobox('loadData', result.records)
	} catch (err) {
		console.log(err)
	}
}
