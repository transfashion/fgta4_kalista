...
import * as hnd from  './fggroup-edit-hnd.mjs'
...
const obj = {
	txt_group_id: $('#pnl_edit-txt_group_id'),
	txt_group_name: $('#pnl_edit-txt_group_name'),
	txt_group_descr: $('#pnl_edit-txt_group_descr'),
	chk_group_disabled: $('#pnl_edit-chk_group_disabled'),
	txt_group_menu: $('#pnl_edit-txt_group_menu'),
	cbo_dash_id: $('#pnl_edit-cbo_dash_id')
}
...
export async function init(opt) {
	...
	obj.cbo_dash_id.name = 'pnl_edit-cbo_dash_id'		
...
export function open(data, rowid, viewmode=true, fn_callback) {
	...
	var fn_dataopened = async (result, options) => {
		...
		/*
		if (result.record.dash_id==null) { result.record.dash_id='--NULL--'; result.record.dash_name='NONE'; }
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		$ui.getPages().ITEMS['pnl_editgroupdashgrid'].handler.createnew(data, options)
		$ui.getPages().ITEMS['pnl_editgrouprolegrid'].handler.createnew(data, options)
...
async function form_datasaving(data, options) {
	...
	// options.skipmappingresponse = ['dash_id', ];
...
async function form_datasaved(result, options) {
	...
	/*
	form.setValue(obj.cbo_dash_id, result.dataresponse.dash_name!=='--NULL--' ? result.dataresponse.dash_id : '--NULL--', result.dataresponse.dash_name!=='--NULL--'?result.dataresponse.dash_name:'NONE')
