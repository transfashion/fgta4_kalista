...
if (is_file(__DIR__ .'/fggroup.php-handler.php')) {
	require_once __DIR__ .'/fggroup.php-handler.php';
}

/**
 * fgta/framework/fggroup/fggroup.php
 *
 * ===================================================================
 * Entry point Program Module fggroup
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\fggroup_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new fggroup_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
