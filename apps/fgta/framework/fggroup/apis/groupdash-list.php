...
/**
 * fgta/framework/fggroup/apis/groupdash-list.php
 *
 * ==============
 * Detil-DataList
 * ==============
 * Menampilkan data-data pada tabel groupdash fggroup (fgt_groupdash)
...
$API = new class extends fggroupBase {
	...
	public function execute($options) {
		...
		if (class_exists($handlerclassname)) {
			$hnd = new fggroup_groupdashHandler($options);
			$hnd->caller = $this;
			$hnd->db = $this->db;
			$hnd->auth = $this->auth;
