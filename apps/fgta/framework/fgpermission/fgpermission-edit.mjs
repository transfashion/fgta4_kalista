...
import * as hnd from  './fgpermission-edit-hnd.mjs'
...
const obj = {
	txt_permission_id: $('#pnl_edit-txt_permission_id'),
	txt_permission_name: $('#pnl_edit-txt_permission_name'),
	txt_permission_descr: $('#pnl_edit-txt_permission_descr')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_permission_id,
		autoid: false,
		logview: 'fgt_permission',
...
function form_idsetup(options) {
	var objid = obj.txt_permission_id
