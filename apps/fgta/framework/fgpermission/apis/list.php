...
/**
 * fgta/framework/fgpermission/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header fgpermission (fgt_permission)
...
$API = new class extends fgpermissionBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.permission_id LIKE CONCAT('%', :search, '%') OR A.permission_name LIKE CONCAT('%', :search, '%') "
			];
