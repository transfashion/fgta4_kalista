...
if (is_file(__DIR__ .'/fgpermission.php-handler.php')) {
	require_once __DIR__ .'/fgpermission.php-handler.php';
}

/**
 * fgta/framework/fgpermission/fgpermission.php
 *
 * ===================================================================
 * Entry point Program Module fgpermission
 * ===================================================================
...
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\fgpermission_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new fgpermission_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
