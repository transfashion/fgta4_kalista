...
import * as hnd from  './msgtype-edit-hnd.mjs'
...
const obj = {
	txt_msgtype_id: $('#pnl_edit-txt_msgtype_id'),
	txt_msgtype_name: $('#pnl_edit-txt_msgtype_name')
}
