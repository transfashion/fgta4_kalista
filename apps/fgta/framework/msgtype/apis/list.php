...
/**
 * fgta/framework/msgtype/apis/list.php
 *
 * ========
 * DataList
 * ========
 * Menampilkan data-data pada tabel header msgtype (mst_msgtype)
...
$API = new class extends msgtypeBase {
	...
	public function execute($options) {
		...
		try {
			...
			$criteriaValues = [
				"search" => " A.msgtype_id LIKE CONCAT('%', :search, '%') OR A.msgtype_name LIKE CONCAT('%', :search, '%') "
			];
			if (is_object($hnd)) {
