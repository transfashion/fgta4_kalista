...
if (is_file(__DIR__ .'/fglongtask.php-handler.php')) {
	require_once __DIR__ .'/fglongtask.php-handler.php';
}

/**
 * fgta/framework/fglongtask/fglongtask.php
 *
 * ===================================================================
 * Entry point Program Module fglongtask
 * ===================================================================
 ...
 * awal dibuat tanggal 18/06/2023
 * terakhir di generate tanggal 08/07/2023
 */
$MODULE = new class extends WebModule {
	...
	public function LoadPage() {
		...
		$handlerclassname = "\\FGTA4\\module\\fglongtask_pageHandler";
		if (class_exists($handlerclassname)) {
			$hnd = new fglongtask_pageHandler();
			$hnd->caller = &$this;
			$hnd->auth = $this->auth;
