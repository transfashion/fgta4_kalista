...
import * as hnd from  './fglongtask-edit-hnd.mjs'
...
const obj = {
	txt_longtask_id: $('#pnl_edit-txt_longtask_id'),
	txt_longtask_name: $('#pnl_edit-txt_longtask_name'),
	txt_longtask_start: $('#pnl_edit-txt_longtask_start'),
	txt_longtask_expired: $('#pnl_edit-txt_longtask_expired'),
	txt_longtask_progress: $('#pnl_edit-txt_longtask_progress'),
	txt_longtask_taskdescr: $('#pnl_edit-txt_longtask_taskdescr'),
	txt_longtask_logfile: $('#pnl_edit-txt_longtask_logfile'),
	txt_longtask_lastprogressid: $('#pnl_edit-txt_longtask_lastprogressid'),
	chk_longtask_isrunning: $('#pnl_edit-chk_longtask_isrunning'),
	chk_longtask_isrequestcancel: $('#pnl_edit-chk_longtask_isrequestcancel'),
	chk_longtask_iscanceled: $('#pnl_edit-chk_longtask_iscanceled'),
	chk_longtask_iscomplete: $('#pnl_edit-chk_longtask_iscomplete'),
	chk_longtask_iserror: $('#pnl_edit-chk_longtask_iserror')
}
...
export async function init(opt) {
	...
	form = new global.fgta4form(pnl_form, {
		primary: obj.txt_longtask_id,
		autoid: false,
		logview: 'fgt_longtask',
...
export function createnew() {
	form.createnew(async (data, options)=>{
		...
		data.longtask_progress = 0
		data.longtask_isrunning = '0'
		data.longtask_isrequestcancel = '0'
		data.longtask_iscanceled = '0'
		data.longtask_iscomplete = '0'
		data.longtask_iserror = '0'
