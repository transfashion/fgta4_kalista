...
import * as apis from './formdevjurn.apis.mjs'
import * as pList from './formdevjurn-list.mjs'
import * as pEdit from './formdevjurn-edit.mjs'
import * as pEditJurnaldetilgrid from './formdevjurn-jurnaldetilgrid.js'
import * as pEditJurnaldetilform from './formdevjurn-jurnaldetilform.js'
import * as pEditJurnalpaymngrid from './formdevjurn-jurnalpaymngrid.js'
import * as pEditJurnalpaymnform from './formdevjurn-jurnalpaymnform.js'
import * as pEditInfo from './formdevjurn-info.js'
import * as pEditLog from './formdevjurn-log.js'
